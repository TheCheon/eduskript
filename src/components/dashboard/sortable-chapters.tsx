        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <Link href={`/dashboard/scripts/${scriptSlug}/chapters/${chapter.slug}`}>
              <h3 className="font-medium text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors">
                {chapter.title}
              </h3>
            </Link>
      ...
      {chapter.pages.length > 0 && (
        <div className="border-t bg-gray-50 dark:bg-gray-800/50">
          <div className="p-4 space-y-2">
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Pages</h4>
            <SortablePages
              pages={chapter.pages}
              chapterId={chapter.id}

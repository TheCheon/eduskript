...
- **Source code** (everything in the git repository) → [AGPL v3](https://www.gnu.org/licenses/agpl-3.0.html)
- **Content** (everything stored in the database) → [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)
...
1. **Discovery** — you can see where a skript originated and find the upstream version
2. **Attribution** — the fork link satisfies the CC BY-NC-SA attribution requirement, both on-platform and as a reference for anyone taking content off-platform
...
> _"Authors share ownership of the content. Contributors help edit but don't gain ownership."_
